...
export class VistaCrear extends Vista{
	...
	*/
	registrar(docPlantilla){
		...
		this.html.div=$('div',docPlantilla)	//this.html.div = docPlantilla.getElementsByTagName('div')[0]
		this.html.iNombre=$('input',docPlantilla)	//this.html.iNombre = docPlantilla.getElementsByTagName('input')[0]
		this.html.btnAceptar=$('button',docPlantilla)	//this.html.btnAceptar = docPlantilla.getElementsByTagName('button')[0]
	}
	/**
